    ...
    return (
      ...
      >
        <div className="flex flex-col gap-1.5 min-w-0">
          ...
          {req.description && (
            <div
              className={`text-sm break-words overflow-wrap-anywhere ${isNegativeTerminal ? (isExpired ? "text-amber-700 dark:text-amber-200" : "text-red-700 dark:text-red-200") : isCompleted ? "text-gray-600 dark:text-gray-400" : "text-gray-700 dark:text-gray-200"}`}
            >
