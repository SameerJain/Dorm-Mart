    ...
    sections: [
      {
        title: "1) Scope",
        paragraphs: [
          "This Policy applies to the Dorm Mart website/app (“Service”). By using the Service, you agree to this Policy and our Terms & Conditions.",
        ],
      },
      {
        ...
        groups: [
          ...
          },
          {
            title: "Usage & Device",
            items: [
              "Log data (IP, timestamps, pages/features used)",
              "Device/browser info",
          ...
          {
            title: "Support",
            items: ["Messages you send to support and related metadata"],
          },
        ],
        after: [
        ...
        groups: [
          {
            ...
            items: [
              "Service/transactional emails (required)",
              "Promotional emails (only if you opt-in; you can opt out anytime)",
            ],
          },
        ],
      },
      {
        ...
        items: [
          "Performance of a contract (provide the Service)",
          "Legitimate interests (secure, improve, prevent fraud)",
          "Consent (promotional emails, certain cookies)",
          "Legal obligations (comply with law/enforce Terms)",
        ],
      },
      {
        ...
        after: [
          "Your public listings and profile details are visible to other users. Direct messages are visible to the participants and system admins strictly as needed for trust & safety or legal compliance.",
        ],
      },
      {
        title: "6) Cookies & Tracking",
        items: [
          "Strictly Necessary (auth/session, security): required.",
          "Analytics/Performance: aggregated usage to improve UX (only with legitimate interest or consent, depending on jurisdiction).",
          "No third-party advertising cookies.",
        ],
        after: [
          "Your browser may offer “Do Not Track”; we currently do not respond to DNT signals.",
        ],
      },
      {
      ...
      },
      {
        title: "8) Security",
        paragraphs: [
          "We implement administrative, technical, and physical safeguards appropriate to the risk (e.g., encryption in transit, access controls, monitoring, hardened configurations). No system is 100% secure. If we detect an incident, we will investigate, mitigate, notify affected users and authorities as required by law (e.g., NY SHIELD Act).",
        ],
      },
      {
        title: "9) Your Choices & Rights",
        items: [
          "Access/Update: edit profile data in your account.",
          "Delete: request account deletion; we’ll remove or de-identify data not required for legal/security/audit purposes.",
          "Opt-Out of promos: unsubscribe links in emails or update preferences.",
          "Copy/Portability/Restriction/Objection: available where applicable law provides these rights.",
        ],
        after: [
          "Contact us (below) to exercise rights. We may verify your identity.",
        ],
      },
      {
        title: "10) Geographic Considerations",
        items: [
          "Hosting: generally in the United States.",
          "International Students: if you access from outside the U.S., your data will be processed in the U.S., which may have different protections than your country.",
        ],
      },
      {
        title: "11) Student Status & FERPA",
        paragraphs: [
          "Dorm Mart is a student-to-student marketplace and not an educational institution or service provider to UB for education records. FERPA generally does not apply to data you provide to us. Use discretion; do not share sensitive academic information on the platform.",
        ],
      },
      {
        title: "12) Minors",
        paragraphs: [
          "The Service is for adults (18+). Do not use the Service if you are under 18.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          "We may update this Policy. Material changes will be posted with a new “Last Updated” date. Continued use means you accept the changes.",
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        after: [
          "Dorm Mart reserves the right to suspend or terminate accounts that violate these conditions.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: ["By using Dorm Mart, you agree to:"],
        items: [
          "Provide accurate and truthful information when creating listings or accounts.",
          "Communicate respectfully with other users.",
          "Conduct transactions safely and honestly.",
          "Meet in public or safe locations for in-person exchanges.",
          "Report suspicious or fraudulent behavior immediately.",
        ],
        after: [
          "You are solely responsible for your interactions with other users, including any agreements, disputes, or damages arising from your transactions.",
        ],
      },
      {
        title: "4. Prohibited Items and Activities",
        paragraphs: ["The following may not be listed, sold, or promoted on Dorm Mart:"],
        items: [
          "Alcohol, tobacco, or controlled substances.",
          "Weapons, ammunition, or explosives.",
          "Stolen, counterfeit, or illegal goods.",
          "Digital goods requiring license transfers.",
          "Academic materials that violate university integrity policies.",
          "Any item or activity prohibited under UB’s Student Code of Conduct or New York State Law.",
        ],
        after: [
          "Dorm Mart reserves the right to remove any listing or suspend accounts that violate these restrictions.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: ["Dorm Mart, its developers, and affiliated parties assume no responsibility for:"],
        items: [
          "Damages, losses, or injuries resulting from transactions or interactions between users.",
          "Misrepresentation of products or services.",
          "Any content posted by users.",
          "Technical issues, service interruptions, or data loss.",
        ],
        after: [
          "Dorm Mart is provided “as is” without any warranties, express or implied.",
        ],
      },
      {
        title: "7. Account Suspension and Termination",
        paragraphs: ["Dorm Mart reserves the right to:"],
        items: [
          "Remove any listing deemed inappropriate or fraudulent.",
          "Suspend or delete user accounts violating these Terms.",
          "Restrict access to the platform for any reason deemed necessary to maintain safety or compliance.",
        ],
      },
      {
        title: "8. Privacy",
      ...
      },
      {
        ...
        paragraphs: [
          "All disputes arising from the use of Dorm Mart must be resolved between the involved users.",
          "Dorm Mart does not mediate transaction-related conflicts.",
          "However, users may report misconduct or safety issues to UB Campus Police or Dorm Mart administrators for investigation.",
        ],
      },
      {
        title: "10. Amendments",
        paragraphs: [
          "Dorm Mart may update these Terms and Conditions at any time without prior notice.",
          "Continued use of the platform after such updates constitutes acceptance of the revised terms.",
        ],
      },
    ],
    closing:
      "By clicking “Confirm” or using Dorm Mart, you acknowledge that you have read, understood, and agreed to these Terms and Conditions.",
  },
};
