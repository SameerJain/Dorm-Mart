...
function ResetPasswordConfirmation() {
  ...
  return (
    <div className="h-dvh flex flex-col md:flex-row pre-login-bg overflow-hidden">
      ...
      <div className="w-full md:w-1/2 flex flex-col items-center justify-center p-4 sm:p-6 md:p-8 pb-[max(1rem,env(safe-area-inset-bottom))] h-dvh pre-login-bg relative overflow-hidden">
