<?php
/**
 * Calls the canonical purchase-history endpoint for a future calendar year.
...
$result = api_test_post_json('purchase-history/fetch-transacted-items.php', ['year' => $futureYear]);
